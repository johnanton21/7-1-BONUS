...
public class EducationRepository {
   ...
   *
   * <p>Executes a {@code SELECT * FROM EDUCATION} query and maps each result
   ...
   *
   * <p>Executes an {@code INSERT INTO EDUCATION} statement using the data
   ...
   *
   * <p>Updates the name and euro amount of an education record identified
