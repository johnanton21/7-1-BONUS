 ...
 *
 * <p>This entity encapsulates budget-related information grouped by a major
 * financial category, including the ministry name and the corresponding
 * amount expressed in euros.

 *
 * <p>It is primarily used as a data transfer and persistence object within
...
public class FinanceMinistry {
   ...
   *
   * <p>Each instance represents a financial record associated with a ministry,
