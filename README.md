...
-Το module **bootstrap** είναι το module, που περιέχει την main κλάση, η οποία με την σειρά της καλεί τις επιμέρους κλάσεις των αντίστοιχων modules.
- Το module **data-management** διαχειρίζεται την πρόσβαση σε σχεσιακή βάση δεδομένων (Railway), οργανωμένη σε πίνακες όπως Expenditure και Revenue. Η σύνδεση υλοποιείται με JDBC μέσω των δομών Connection, PreparedStatement και ResultSet, ενώ κάθε εγγραφή της βάσης μετασχηματίζεται σε αντικείμενα οντοτήτων (Expenditure, Revenue) και αποθηκεύεται προσωρινά σε συλλογές τύπου List/ArrayList. Οι βασικοί αλγόριθμοι περιλαμβάνουν σειριακή ανάκτηση και μετατροπή δεδομένων (row mapping) γραμμικής πολυπλοκότητας O(n), καθώς και CRUD λειτουργίες μέσω παραμετρικών SQL εντολών.
- Το module **functions**  χρησιμοποιεί λίστες εσόδων και δαπανών για τον υπολογισμό συνολικών ποσών με γραμμική σάρωση, τον υπολογισμό του δημοσιονομικού ισοζυγίου ως διαφορά εσόδων και δαπανών και τη λογική απόφασης για τον χαρακτηρισμό του προϋπολογισμού ως πλεονασματικού, ελλειμματικού ή ισοσκελισμένου. Επιπλέον, εφαρμόζεται αλγόριθμος κανονικοποίησης ποσών που μετατρέπει οικονομικές τιμές από συμβολοσειρές σε αριθμητική μορφή κατάλληλη για υπολογισμούς. Στα αρχεία test, ακόμη,  υποστηρίζεται ο έλεγχος ορθότητας της εφαρμογής με δοκιμαστικά δεδομένα και fake repositories, επαληθεύοντας τους διάφορους αλγορίθμους.
- Το module **graphics** αναλαμβάνει την οπτικοποίηση των δεδομένων, χρησιμοποιώντας συγκεντρωτικές αριθμητικές τιμές και δομές δεδομένων γραφημάτων που προκύπτουν από γραμμική επεξεργασία λιστών, για τη δημιουργία κυκλικών και συγκριτικών γραφημάτων.
